...
| [aws-startup-advisor](plugins/aws-startup-advisor/)           | Startup-focused AWS guidance for founders: stage-aware architecture and cost advice, AWS Activate credits and partner offers, and migrations to AWS from GCP, Heroku, and non-AWS LLM providers (OpenAI, Gemini, Anthropic) to Amazon Bedrock.                                                                                                                                     |
